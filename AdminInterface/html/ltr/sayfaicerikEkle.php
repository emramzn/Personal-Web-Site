                            ...
                            <table class="table">
                                 ...
                                 <!-- KATEGORİLER BÖLÜMÜ YÖNETİMİ BAŞLANGIÇ  -->  
                                     ...
                                     <td style="text-align: center;">
                                      ...
                                      <div class="col-lg-14">
                                        <input type="file" class="form-control"  name="fotoIcerik">
                                      ...
                                      <td style="text-align: center;"><div class="col-lg-14">
                                        <input type="text" class="form-control" placeholder="Başlık" name="sayfaBaslik">
                                       


                                    </div></td>
                                      <td style="text-align: center;"> <div class="col-sm-15">
                                            <textarea class="form-control" placeholder="Kısaca içerik" name="sayfaAciklama"></textarea>
                                          </div></td>
                                        <?php //echo $_GET['sayfaAdi']; ?>
                                          ...
                                          <input type="text" hidden="" name="yazar" value="<?php echo $_SESSION['kullaniciAdi'];?>">
                                           ...
                                           <input type="text" hidden="" name="defaultFoto" value="defaultFoto">
                                          	...
                                          	<td><button class="btn btn-outline-success"  name="yeniIcerikEkle" >EKLE</button></a></td>
                                          </td>
                                ...
                                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                                  <div class="card-body">
                                  	...
                                  	<div class="col-md-12">
									    ...
									    <textarea name="sayfaFullIcerik" id="metin" class="ckeditor"></textarea>
