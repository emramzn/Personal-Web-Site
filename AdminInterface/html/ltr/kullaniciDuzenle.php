                            ...
                            <form class="form-horizontal">
                               ...
                               <label for="fname" class="col-sm-4 text-right control-label col-form-label">Profil Fotoğrafı </label>
                                 <div class="col-sm-4 " >
                                  ...
                                  <input style="display: none;" id="file-picker" type="file" name="userImage"> 
                               ...
                               <label for="fname" class="col-sm-4 text-right control-label col-form-label">Şifre</label>
                                 ...
                                 <div class="col-sm-4" >
                                    <label class="form-control"  > <?php echo $profilBilgi['kullaniciAdi']; ?> </label>
                               
                                 </div>
                                    
                                    </div>
                                      <div class="form-group row">  
                                        <label for="fname" class="col-sm-4 text-right control-label col-form-label"> Yetki </label>
                                        <div class="col-sm-4 " >

                                    <select name="yetki"  class="form-control" >
                                      <option value="1" <?php echo ($profilBilgi['yetki']=='1') ? 'selected': null ?>>ADMİN</option>
                                      <option value="0" <?php echo ($profilBilgi['yetki']=='0') ? 'selected': null ?>>USER</option>
                                    </select>
                                        </div>
                                  </div>
                                 ...
                                 <div class="col-sm-4" >
                                   <input type="text" hidden="" name="kulID" value="<?php echo $profilBilgi['kulid'];?>">
                                    ...
                                    <div class="col-md-8 text-right " >
                                      ...
                                      <input type="Submit" class="btn btn-primary" name="userProfilDuzenle" value="Güncelle" >
