          ...
          <?php 
              ...
              try {
                    ...
                    //  echo  " deneme ID : ".$_POST['icerikId']." GEt  : ".$_GET['id'];    
                      ...
                      $sayfaGetir=$db->query("SELECT * FROM muhsekme WHERE icerikId='$varID' ",PDO::FETCH_ASSOC);
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <img  style="width:120px; height: 120px; margin-top:15px; "  src="../../assets/icerikler/<?php echo $kayitDuzenle['icerikfoto'];?>.jpg" alt=""> 
                                         
                                          <input style="margin-top:25px; " type="file" name="imageIcerikmuh">
                                      ...
                                      <td style="text-align: center;"><div class="col-lg-14">
                               <input type="text" class="form-control" name="baslik"  value="<?php echo $kayitDuzenle['icerikbaslik'];  ?>" >
                          
                                 
                                    </div></td>
                                      <td style="text-align: center;"> <div class="col-sm-15">
                                            <textarea class="form-control " name="aciklama" ><?php echo $kayitDuzenle['aciklama']; ?></textarea>
                                        ...
                                        <input type="submit" name="muhguncelle" class="btn btn-primary">
